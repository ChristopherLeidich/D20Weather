...
class DesertPage extends StatefulWidget {
  const DesertPage({super.key, required this.currentIndex, required this.wind, required this.direction, required this.wetterBedingung, required this.roller, required this.region});
  ...
  @override
  State<DesertPage> createState() => _DesertState();
}


class _DesertState extends State<DesertPage> {
